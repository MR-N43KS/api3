    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Ako Api - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6282149883022">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Ako Office</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Ako Office" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Ako`,
        html: inboxGmail,
      };
